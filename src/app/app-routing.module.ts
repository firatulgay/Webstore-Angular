...
const routes: Routes = [
  ...
  {path:'product-add-1', component : ProductAddClassicFormComponent, canActivate:[LoginGuard]},  // product-add-1 pathindeki componente gitmek için canActivate:[LoginGuard] ile önce Login mi diye bakmasını sağladık.
